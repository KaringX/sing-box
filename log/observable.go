...
func (l *observableLogger) log(ctx context.Context, level Level, deep int, args []any) {
	...
	tag := " " + path.Base(file) + ":" + strconv.Itoa(line) + " " + l.tag
	nowTime := time.Now()
	if l.needObservable {
