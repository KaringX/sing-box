...
func NewServerTransport(ctx context.Context, logger logger.ContextLogger, options option.V2RayTransportOptions, tlsConfig tls.ServerConfig, handler adapter.V2RayServerTransportHandler) (adapter.V2RayServerTransport, error) {
	...
	case C.V2RayTransportTypeXHTTP: //https://github.com/starifly/sing-box
		return xhttp.NewServer(ctx, logger, options.XHTTPOptions, tlsConfig, handler)
	case C.V2RayTransportTypeKCP: //https://github.com/starifly/sing-box
...
func NewClientTransport(ctx context.Context, logger log.ContextLogger, dialer N.Dialer, serverAddr M.Socksaddr, options option.V2RayTransportOptions, tlsConfig tls.Config) (adapter.V2RayClientTransport, error) { //karing
	if options.Type == "" {
		return nil, nil
	}
	switch options.Type {
	...
	case C.V2RayTransportTypeXHTTP: //https://github.com/starifly/sing-box
		return xhttp.NewClient(ctx, logger, dialer, serverAddr, options.XHTTPOptions, tlsConfig) //karing
	case C.V2RayTransportTypeKCP: //https://github.com/starifly/sing-box
