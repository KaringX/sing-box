...
func initFlags() { //karing
	...
	*/
	...
	sharedTags = append(sharedTags, "with_low_memory", "with_tailscale", "with_acme", "with_shadowsocksr", "with_grpc", "with_masque", "with_sudoku", "with_trusttunnel", "with_karing")                                         //karing
