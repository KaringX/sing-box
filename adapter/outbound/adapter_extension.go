...
func (h *Adapter) OnNewConnection(con net.Conn, onAllClosed func()) net.Conn {
	h.ConnectionsIn.Add(1)
	return &tcpConnectionCloseAdapter{Conn: con, OnClosed: func() {
		count := h.ConnectionsIn.Add(-1)
		if count == 0 {
			onAllClosed()
		}
	}}
...
func (h *Adapter) OnNewPacketConnection(con net.PacketConn, onAllClosed func()) net.PacketConn {
	h.ConnectionsIn.Add(1)
